...
describe("controller", function() {
  ...
  it('should highlight "Active" filter when switching to active view', function() {
    // TODO: write test
    // DONE
    //faking the locationHash(href on links)
    let locationHash = "#/active";
    subject.setView(locationHash);
  ...
  describe("routing", function() {
    ...
    it("should show active entries", function() {
      // TODO: write test
      //DONE
      //data.completed equal false because todo still active
  ...
  describe("toggle all", function() {
    beforeEach(() => {
      ...
      setUpModel(todos);
      subject.setView("");
      //trigger the toggleAll event that toggle all todos to 'Completed'
    ...
    it("should toggle all todos to completed", function() {
      ...
      //expect that todos toggle to completed
    ...
    it("should update the view", function() {
      // TODO: write test
      // DONE
      //Once trigger on toggleAll the view changes and...
      //expect that 'first todo' is complete
      expect(view.render).toHaveBeenCalledWith("elementComplete", {
        id: 1,
        completed: true
      });
      //expect that 'second todo' is complete
      expect(view.render).toHaveBeenCalledWith("elementComplete", {
        id: 2,
        completed: true
      });
  ...
  describe("new todo", function() {
    ...
    it("should add a new todo to the model", function() {
      // TODO: write test
      // DONE
      //Then trigger the new todo expect to create into model a new todo
